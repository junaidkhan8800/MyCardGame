...
public class ThirteenCardResultFragment extends Fragment {
    ...
    public ThirteenCardResultFragment() {
        // Required empty public constructor
    }


    public static ThirteenCardResultFragment newInstance(String param1, String param2) {
        ThirteenCardResultFragment fragment = new ThirteenCardResultFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_thirteen_card_result, container, false);

        progressDialog = new ProgressDialog(getContext());
        recyclerView = view.findViewById(R.id.tResultRv);

        list = new ArrayList<>();



//        list.add(new TodayResultHistoryModel(13,"dvsd","vsv"));
//        list.add(new TodayResultHistoryModel(12,"sdvs","srvwv"));
//        list.add(new TodayResultHistoryModel(11,"vwrvwfv","gdffdg"));
//        list.add(new TodayResultHistoryModel(10,"sdfg","fgrgtr"));
//
//        adapter = new TodayResultHistoryAdapter(getContext(),list,2);
//
            ...
            public void onResponse(Call<List<TodayResultHistoryModel>> call, Response<List<TodayResultHistoryModel>> response) {
                ...
                if (response.body() != null) {
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        ...
                        if(list.get(i).getGameType().equals("13"))
                        {
                    ...
                    adapter = new TodayResultHistoryAdapter(getContext(), listnew,2);
                    recyclerView.setAdapter(adapter);
